...
![Day view with a running timer](docs/screenshots/02-day-view-timer-running.png)
...
![Recovery dialog](docs/screenshots/09-timer-recovery-dialog.png)

## Schema

The full Postgres schema — tables, indexes, triggers, Row Level Security policies and the timer functions — is in [`supabase/migrations/0001_init.sql`](supabase/migrations/0001_init.sql) (MIT). Design notes: [docs/timer-design.md](docs/timer-design.md).
